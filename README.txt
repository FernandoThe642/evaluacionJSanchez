...
a persistence unit "evaluacionSanchezPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "evaluacionSanchez/pom.xml":
...
artifact ("evaluacionSanchez.war") is already built. You can build
